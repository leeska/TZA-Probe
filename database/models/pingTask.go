...
type PingTask struct {
	...
	ManagedBy  string      `json:"managed_by,omitempty" gorm:"type:varchar(64);index:idx_ping_task_managed,priority:1"`
	ManagedKey string      `json:"managed_key,omitempty" gorm:"type:varchar(255);index:idx_ping_task_managed,priority:2"`
