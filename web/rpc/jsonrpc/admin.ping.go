...
func adminAddPingTask(_ context.Context, req *rpc.JsonRpcRequest) (any, *rpc.JsonRpcError) {
	...
	taskID, err := tasks.AddPingTaskWithMetadata(params.Clients, params.DefaultOn, params.Name, params.Target, params.TaskType, params.Interval, params.Region, params.Carrier, params.Family)
	if err != nil {
